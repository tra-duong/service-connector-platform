...
namespace Modules\JobRequest\Providers;
...
{
    protected string $moduleName = 'JobRequest';

    protected string $moduleNameLower = 'jobrequest';
    ...
    public function register(): void
    {
        ...
        // Listing.
        $this->app->bind(JobRequestListingRepositoryInterface::class, JobRequestListingRepository::class);
        $this->app->bind(JobRequestListingServiceInterface::class, JobRequestListingService::class);

        // Listing.
        $this->app->bind(JobRequestProcessingRepositoryInterface::class, JobRequestProcessingRepository::class);
        $this->app->bind(JobRequestProcessingServiceInterface::class, JobRequestProcessingService::class);
